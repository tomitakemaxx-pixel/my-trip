...
| ファイル | 用途 |
|---|---|
| `dist/三十路会_佐賀福岡旅行しおり_ver01.docx` | 編集用。A4縦・21ページ・Yu Gothic・文書プロパティの作成者は「高山」 |
...
`assets/img/` の写真はすべてウィキメディア・コモンズの自由利用可能な画像です。
一覧と撮影者・ライセンスは [`IMAGE_CREDITS.md`](IMAGE_CREDITS.md) を参照してください。

らかんの湯の薪サウナ・露天風呂など、施設内部の写真は公開されているものがないため、
雰囲気の近い別の場所の写真を「イメージ」として掲載し、その旨をしおり本文に明記しています。
